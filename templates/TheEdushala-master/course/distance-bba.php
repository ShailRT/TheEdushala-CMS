...
<html lang="en">
	<head>
		...
		<meta content="BBA Distance Regular Information Admission Fees " name="description">

		<meta content="The Edushala" name="author">
		<meta name="keywords" content="bba , bba distance ,  bba regular, bba fees,  bba delhi admission, bba information"/>
		...
		<!-- Title -->
		<title> BBA - Course, Fees, Admission, Colleges ; The Edushala</title>
	...
	<body>
								...
								<div class="row">
									<div class="col-xl-9 col-lg-12 col-md-12 d-block mx-auto">
										<div class="text-center text-white text-property">
											<h1 class=""><span class="font-weight-bold"></span> Bachelors of Business Administration [BBA] <br> 
		...
		<div class="bg-white border-bottom">
			<div class="container">
				<div class="page-header">
					<h4 class="page-title">Bachelors in Bussiness Administration</h4>
					<ol class="breadcrumb">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="mb-4 description" id="what-bba">
										<p  >BBA Course is a three year undergraduate business management course that imparts managerial and entrepreneurial skills to students through BBA Subjects like General Management, Managerial Economics.   

											</p>
										<p>BBA Admissions 2021 is done on the basis of entrance exams as well as on the basis of merit in Top BBA Colleges in India. Cities like Delhi, Mumbai, Kolkata, Pune, Bangalore have some of the best BBA Colleges. BBA Colleges in mumbai includes SP Jain, Whistling Woods etc.</p>
										<p > <b>What is BBA?</b> </p> 
										...
										<div class="row" >
											<div class="col-xl-6 col-md-12">
												<ul class="list-unstyled widget-spec-1">
													<li class="text-default-dark"><i class="text-default fe fe-star"></i><span>Business development </span></li>
													<li class="text-default-dark"><i class="text-default fe fe-star"></i><span>HR manager </span></li>
													<li class="text-default-dark"><i class="text-default fe fe-star"></i><span>Data scientists  </span></li>
													<li class="text-default-dark"><i class="text-default fe fe-star"></i><span>Product Manager </span></li>
										...
										<p>
											<strong>Courses  after BBA</strong>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>Degree</th>
										...
										<p>
											<strong id="college-bba">Top Colleges in India for BBA</strong>
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>College</th>
												...
												<tr>
													<td>HR college of commerce and economics, Mumba </td>
													<td>www.hrcollege.edu</td>
												</tr>
												<tr>
													<td>Institute of Management, Christ university,Bangalore</td>
													<td>https://christuniversity.in</td>
												</tr>
												<tr>
													<td>UPES ,Dehradun</td>
													<td>www.upes.ac.in</td>
												</tr>
												<tr>
													<td>Shaheed Sukhdev college of business,Delhi </td>
													<td>https://sscbdu.ac.in</td>
												</tr>
												<tr>
													<td>NMIMS,Mumbai</td>
													<td>Jttps://nmims.edu</td>
												</tr>
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						...
						<div class="card">
							...
							<div class="card-body item-user bg-white">
								...
								<div>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></span><a href="#what-bba" class="text-body"> BBA INFO</a></h6>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></span><a href="#carrer-bba" class="text-body"> Carrer in BBA</a></h6>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></i></span><a href="#special-bba" class="text-body">BBA Specialisation</a></h6>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></span><a href="#college-bba" class="text-body">Top BBA Colleges</a></h6>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></span><a href="#exam-bba" class="text-body">BBA Entrance Exams</a></h6>
									<h6 class="mb-3"><span class="font-weight-semibold"><i class="fe fe-link me-2 mb-2"></i></span><a href="#salary-bba" class="text-body">Salary after BBA</a></h6>
								</div>
							</div>
							<!-- <div class="card-footer">
		...
		<!-- Message Modal -->
		<?php 
		$coursename = "Bachelors of Business Administration [BBA]";
