...
<html lang="en">
	<head>
		...
		<meta content="Institute of Management Technology" name="description">
		<meta content="The Edushala" name="author">
		<meta name="keywords" content="Institute of Management Technology, Regular Colleges, IMT Admission, IMT Courses"/>
		...
		<!-- Title -->
		<title>Institute of Management Technology</title>
							...
							<div class="container">
								<div class="row">
									<div class="col-xl-8 col-lg-7 col-md-12">
										<div>
											<h1 class="text-white display-5 font-weight-semibold text-uppercase">Institute of Management Technology</h1>
											...
											<div class="d-block d-md-flex align-items-center mb-5">
												...
												<span class="text-white ms-3"><i class="fe fe-bar-chart text-white-50 text-uppercase"></i>Ranked 2 For Overall By TOI</span>
												<span class="ms-4">
							...
							<div class="tab-content border-0 p-5 bg-white details-tab-content">
								<div class="tab-pane active" id="tab-1">
									...
									<div class="mb-0 description">
										<p>The Institute of Management Technology, Ghaziabad (IMT G) is a private business school with its main campus in Ghaziabad, Uttar Pradesh, India. It is frequently placed among India's Top 10 private business schools and North India's Top 5 private business schools. It is an AICTE-accredited business school that offers management postgraduate diploma and executive education programmes. It also offers collaborative and distance learning programmes.</p>
										<p>Shri Mahendra Nath established the Dr. K. Nath Public Trust with the purpose of establishing and supporting trade schools and higher education institutions. Among the trust's projects are administering libraries and assisting disadvantaged students in pursuing higher education at a number of institutions, including the Indian Institute of Technology and the Indian Institute of Management. The trust assisted in the establishment of IMT in 1980 with financial support from the Lajpat Rai Educational Society, and the IMT received AICTE approval in 1983. Kanishka Pandey is the director of the Institute of Management Technology's sports research centre.</p>


										<p> <strong>Ranking </strong> </p>
										<div class="row" >
											<p>IMT was ranked #7 among the best Indian B-Schools by the Economic Times in 2018, 37 among management schools in India by the National Institutional Ranking Framework (NIRF) in 2020,, 12 by Business Today's "India's best B-schools 2019"and 15 in India by Outlook India's "Top 150 Private MBA Institutions" in 2020.</p>
										
										</div>
										
										
										<p class="pt-3"> <strong> Placement</strong></p>
										<p>Despite the breakout of COVID pandemics, the institute was able to complete all of its placements with a 100% success rate. The average CTC for the PGDM Executive class of 2019-20 increased by 80%.</p>
										<p>Top Recruiting companies are:</p>
										...
										<p class="pt-5"> <strong>Eligibility criteria</strong> </p>
										<p>The eligibility criteria for getting admission in IMT Ghaziabad is as follows.</p>
										...
										<p>
											<table class="table table-bordered">
												...
												<tbody>
												<tr>
													<td>PGDM marketing/PGDM Finance</td>
													<td>Graduation + CAT / XAT / GMAT scores</td>
												</tr>
												<tr>
													<td>PGDM</td>
													<td>Graduation + CAT / XAT / GMAT scores</td>
												...
												<tr>
													<td>FPM</td>
													<td>PG degree + CAT / GMAT / GRE / GATE / UGC-NET scores</td>
												</tr>
												</tbody>
										    </table>
										</p>
								...
								<div class="tab-pane" id="tab-2">
									...
									<p>The institute provides full-time (2 years) and part-time (3 years) PGDM programmes in six specialisations, a 15-month Executive PGDM (ePGDM) programme for working professionals, and a four- to five-year Fellowship Programme in Management (FPM) in nine specialisations at the doctoral level.</p>
								...
								<div class="tab-pane" id="tab-3">
									...
									<h3 class="card-title mb-3 font-weight-bold">ADMISSION CRITERIA</h3>
										<p>The admission criteria for different courses is given below.</p>
										<p>Admission to IMT G is a three-step process. In big cities, the top percentiles on the CAT/XAT/GMAT are summoned for a group discussion/activity. The profiles of potential participants are assessed. A personal interview with two faculty members follows the discussion/activity. After that, the pupils with the highest cumulative score are given a final call. Admission privileges are reserved for the administration.</p>
										<!-- <p>
											<table class="table table-bordered">
												<thead>
												<tr>
							...
							<div class="card-body product-filter-desc">
								<div class="product-tags clearfix">
									<ul class="list-unstyled mb-0">
										<li><a href="javascript:void(0)">Institute of Management Technology</a></li>
										<li><a href="javascript:void(0)">Regular/Distance</a></li>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="examplecontactLongTitle">Institute of Management Technology, Ghaziabad</h5>
					...
					<div class="modal-body">
						<div class="form-group">
							<input type="text " class="form-control" id="contact-name" placeholder="Your Name" style="color: white;">
						</div>
						<div class="form-group">
