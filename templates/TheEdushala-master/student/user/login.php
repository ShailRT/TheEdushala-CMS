                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" action="" name="login"  method="post">  
                      ...
                      <div class="row">
                       ...
                       <div class="col-12 col-sm-12 col-md-12 d-flex justify-content-between mt-1 me-5">
                          <div class="1">
                            <a href="forget-password.php">Forgot password?</a></div>
                            <div class="2"><a href="../admin/login.php">Admin login?</a></div>
