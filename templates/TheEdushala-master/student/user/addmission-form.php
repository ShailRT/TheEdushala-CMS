...
<tr>
  ...
  <td><?php echo $row['CourseApplied'];
  $courseApply=$row['CourseApplied'];?>
  <?php $query=mysqli_query($con, "update tbluser set Course='$courseApply' where ID='$uid'"); ?></td>
</tr>
<tr>
  <th>Student Pic</th>
...
<select class="form-control white_bg" id="category" name="session"  required>
