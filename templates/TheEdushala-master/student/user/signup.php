...
echo "<script>alert('This email or Contact Number already associated with another account');</script>";
    ...
    $query=mysqli_query($con, "insert into tbluser(FirstName, LastName,MobileNumber, Email,  Password, State, City) value('$fname', '$lname','$contno', '$email', '$password', '$state', '$city ')");
    if ($query) {
