...
?>
<li style="list-style-type:none;"><h5><i class="fa fa-bookmark" aria-hidden="true"></i> <a href="notice-details.php?nid=<?php echo $row['ID'];?>" target="_blank"><?php echo $row['Title'];?></a></h3></li>
<?php } ?>
        <!-- Input Mask start -->
