...
<li class=" nav-item"><a href="#"><i class="fa fa-check-square-o" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.footers.main">Admission application</span></a>
...
<li class=" nav-item"><a href="#"><i class="fa fa-university" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.footers.main">Course</span></a>
          <ul class="menu-content">
...
<!-- <li class=" nav-item"><a href="#"><i class="fa fa-book" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.footers.main">Manage Books</span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="payment.php"><i class="fa fa-credit-card-alt" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.dash.main">Payment Edit</span></a>
        </li>

        <li class=" nav-item"><a href="createUser.php"><i class="fa fa-user" aria-hidden="true"></i><span class="menu-title" data-i18n="nav.dash.main">Create User</span></a>
        </li>
      </ul>
    </div>
  </div>